...
|---------|-----------|--------------|
| `fractal_dimension` | 0.1232 | Fraktale Dimension (≈2: raumfüllend) |
| `alpha` | 0.1175 | Anomaler Exponent aus MSD (α<1: sub, α=1: normal, α>1: super) |
| `hurst_exponent` | 0.1164 | Hurst-Exponent H = α/2 für fBm-Identifikation |
| `space_exploration_ratio` | 0.1153 | Feature |
| `convex_hull_area` | 0.0935 | Feature |
| `msd_ratio` | 0.0830 | MSD-Ratio R(4,1) - Plateaubildung bei Confinement |
| `vacf_lag1` | 0.0822 | Velocity Autocorrelation bei Lag 1 (wichtigstes Feature) |
| `mean_cos_theta` | 0.0817 | Mean Cosine Turning Angles (>0.5: persistent) |
| `efficiency` | 0.0580 | Nettoverschiebungs-Effizienz (→0: confined) |
| `vacf_min` | 0.0499 | Minimum der VACF (negative Werte bei Subdiffusion) |
| `msd_plateauness` | 0.0291 | Feature |
| `persistence_length` | 0.0281 | Persistence Length (>>Schritt bei Superdiffusion) |
| `asphericity` | 0.0113 | Räumliche Asymmetrie (→1: linear, →0: isotrop) |
| `straightness` | 0.0080 | Straightness Index D/L (hoch bei Superdiffusion) |
| `boundary_proximity_var` | 0.0026 | Feature |
| `confinement_probability` | 0.0002 | Feature |
| `kurtosis` | 0.0000 | Excess Kurtosis - Gaussianität (≈0: fBm, >0: CTRW) |
| `rg_saturation` | 0.0000 | Radius of Gyration Sättigung (Plateau: confined) |
