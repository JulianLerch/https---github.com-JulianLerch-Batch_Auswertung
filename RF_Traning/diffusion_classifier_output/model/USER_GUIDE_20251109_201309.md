...
|---------|-----------|--------------|
| `space_exploration_ratio` | 0.1543 | Feature |
| `fractal_dimension` | 0.1134 | Fraktale Dimension (≈2: raumfüllend) |
| `convex_hull_area` | 0.1086 | Feature |
| `alpha` | 0.0990 | Anomaler Exponent aus MSD (α<1: sub, α=1: normal, α>1: super) |
| `hurst_exponent` | 0.0899 | Hurst-Exponent H = α/2 für fBm-Identifikation |
| `vacf_lag1` | 0.0875 | Velocity Autocorrelation bei Lag 1 (wichtigstes Feature) |
| `msd_ratio` | 0.0842 | MSD-Ratio R(4,1) - Plateaubildung bei Confinement |
| `mean_cos_theta` | 0.0713 | Mean Cosine Turning Angles (>0.5: persistent) |
| `vacf_min` | 0.0499 | Minimum der VACF (negative Werte bei Subdiffusion) |
| `persistence_length` | 0.0337 | Persistence Length (>>Schritt bei Superdiffusion) |
| `asphericity` | 0.0336 | Räumliche Asymmetrie (→1: linear, →0: isotrop) |
| `msd_plateauness` | 0.0330 | Feature |
| `efficiency` | 0.0279 | Nettoverschiebungs-Effizienz (→0: confined) |
| `straightness` | 0.0132 | Straightness Index D/L (hoch bei Superdiffusion) |
| `confinement_probability` | 0.0003 | Feature |
| `boundary_proximity_var` | 0.0002 | Feature |
| `rg_saturation` | 0.0001 | Radius of Gyration Sättigung (Plateau: confined) |
| `kurtosis` | 0.0001 | Excess Kurtosis - Gaussianität (≈0: fBm, >0: CTRW) |
